...
public class Prettify {
  ...
  public Prettify() {
    try {
      ...
      registerLangHandler(new CreateSimpleLexer(shortcutStylePatterns, fallthroughStylePatterns), Arrays.asList("default-markup", "htm", "html", "mxml", "xhtml", "xml", "xsl"));
      ...
      registerLangHandler(new CreateSimpleLexer(shortcutStylePatterns, fallthroughStylePatterns), Arrays.asList("in.tag"));

      shortcutStylePatterns = new ArrayList<List<Object>>();
      fallthroughStylePatterns = new ArrayList<List<Object>>();
      fallthroughStylePatterns.add(Arrays.asList(new Object[]{PR_ATTRIB_VALUE, Pattern.compile("^[\\s\\S]+")}));
      registerLangHandler(new CreateSimpleLexer(shortcutStylePatterns, fallthroughStylePatterns), Arrays.asList("uq.val"));
      ...
      registerLangHandler(sourceDecorator(decorateSourceMap), Arrays.asList("c", "cc", "cpp", "cxx", "cyc", "m"));
      ...
      registerLangHandler(new CreateSimpleLexer(shortcutStylePatterns, fallthroughStylePatterns), Arrays.asList("regex"));
